...
var _sdk = __webpack_require__(53);

var _sdk2 = _interopRequireDefault(_sdk);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var bus = new _sdk2.default(0, 0, "https://apibus.tao11.la/", {
...
var _md = __webpack_require__(97);
...
function ApiBus(appkey, secret, url, jsoner) {
    ...
    function Signature(options, secret) {
        ...
        for (var key in options) {
            var v = options[key];
            if (v === null || v === undefined || v === '' || key == 'signature') continue;
            if ((typeof v === "undefined" ? "undefined" : (0, _typeof3.default)(v)) === "object") {
                kv.push(key + '=' + (0, _stringify2.default)(options[key]));
            } else {
        ...
        options['signature'] = (0, _md2.default)(s);
        return options;
    }
