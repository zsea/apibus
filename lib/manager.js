        ...
        handler: {
            ...
            value: async function (ctx, form) {
                ...
                return {
                    ...
                    desc: desc,
                    need_securty: need_securty == 1,
                    must_session: must_session == 1
                };
            }
        }
    },
        ...
        handler: {
            ...
            value: async function (ctx, form) {
                ...
                let apiredis = {
                    ...
                    must_session: apiinfo.must_session == 1,
                    need_securty: apiinfo.need_securty == 1
                }
